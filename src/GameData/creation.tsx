...
export class GameStart {
	...
	static IntroTwo(i:number = 0)
	{
		var ui = new Interface();
	    ui.clearOutput();
		ui.output("This shows that buttons can trigger scenes. Count: "+i++);
        ui.output("\n\nThis shows that buttons can trigger scenes. Count: "+i++);
        ui.output("\n\nThis shows that buttons can trigger scenes. Count: "+i++);
        ui.output("\n\nThis shows that buttons can trigger scenes. Count: "+i++);
        ui.output("\n\nThis shows that buttons can trigger scenes. Count: "+i++);
        ui.output("\n\nThis shows that buttons can trigger scenes. Count: "+i++);
        ...
        ui.output("\n\nThis shows that buttons can trigger scenes. Count: "+i++);
        ui.output("\n\nThis shows that buttons can trigger scenes. Count: "+i++);
		ui.addButton(0, "Repeat"+i, () => GameStart.IntroTwo(i), undefined, "Repeat", "Repeat");
        ui.addButton(1, "Repeat"+i, () => GameStart.IntroTwo(i), undefined, "Repeat", "Repeat");
        ui.addButton(2, "Repeat"+i, () => GameStart.IntroTwo(i), undefined, "Repeat", "Repeat");
        ui.addButton(3, "Repeat"+i, () => GameStart.IntroTwo(i), undefined, "Repeat", "Repeat");
        ui.addButton(4, "Repeat"+i, () => GameStart.IntroTwo(i), undefined, "Repeat", "Repeat");
        ui.addButton(5, "Repeat"+i, () => GameStart.IntroTwo(i), undefined, "Repeat", "Repeat");
        ui.addButton(6, "Clear Buttons"+i, () => {ui.clearMenu();ui.render();}, undefined, "Repeat", "Repeat");
        ui.addDisabledButton(7, "DisableTest");
        ui.render();
	}
    ...
    static StartIntro():void
    {
        var ui = new Interface();
        ui.clearOutput();
        ui.output("There are many, many worlds.");
        ...
        ui.output("\n\nThe mages never stopped trying to find a way home, and as the years passed, their experiments became ever more obscene. The mages were twisted and corrupted by their own desires, and the taint of their black magics spread across Mareth like wildfire. They became <strong>demons</strong>, shedding their humanity at the command of their new queen, Lethice.");
        ...
        ui.clearMenu();
        ui.addButton(0, "Next", () => GameStart.StartII());
        ui.render();
    }
    ...
    static StartII():void
    {
        var ui = new Interface();
        ui.clearOutput();
        ui.output("You have never heard of a world called Mareth, nor a village named Ingnam.");
